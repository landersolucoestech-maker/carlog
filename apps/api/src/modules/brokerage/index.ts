...
export async function registerBrokerageRoutes(app:FastifyInstance):Promise<void>{await registerLeadsRoutes(app);await registerCustomersRoutes(app);await registerQuotesRoutes(app);await registerOrdersRoutes(app);await registerCarriersRoutes(app);await registerDispatchRoutes(app);await registerFinanceRoutes(app)}
